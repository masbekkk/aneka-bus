    ...
    <div class="container-fluid my-4">
        <a href="/jadwal-keberangkatan/detail/6321" class="text-decoration-none">
            <div class="card card-custom bg-white mb-3 p-3">
                <div class="row">
                    <div class="col">
                        <div class="fw-bold">ZF002 - Premiere class</div>
                    </div>
                </div>
                <hr class="my-2">
                <div class="row pt-3 pb-3">
                    <div class="col-md-6">
                        <div class="timeline">
                            <div class="timeline-item">
                                <div class="fw-bold">19:15 PM - Makassar</div>
                                <div class="text-muted">Perwakilan Perintis Kemerdekaan</div>
                            </div>
                            <div class="timeline-item">
                                <div class="fw-bold">06:00 AM - Mamuju</div>
                                <div class="text-muted">Perwakilan Terminal Mamuju</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 text-end">
                        ...
                        <div class="price fw-bold text-red-800">Rp 280,000/Kursi</div>
                        <p class="availability">Tersisa 7 Kursi</p>
                    </div>
                </div>
            </div>
        </a>
