                    ...
                    <div class="card-body p-4">
                        @foreach ($selectedSeat as $key => $seat)
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        <label for="nama_penumpang_{{ $seat }}" class="form-label">Nama Penumpang Sesuai KTP</label>
                                        <input class="form-control" id="nama_penumpang_{{ $seat }}" name="passengers[{{$seat}}][nama_penumpang]" type="text" required>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="mb-3">
                                                <label for="gender_{{ $seat }}" class="form-label text-nowrap">Jenis Kelamin</label>
                                                <select class="form-select" id="gender_{{ $seat }}" name="passengers[{{$seat}}][gender]" required>
                                        ...
                                        <div class="col-sm-8">
                                            <div class="mb-3">
                                                <label for="telepon_{{ $seat }}" class="form-label text-nowrap">Nomor Telepon</label>
                                                <input class="form-control" id="telepon_{{ $seat }}" name="passengers[{{$seat}}][telepon]" type="text" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
